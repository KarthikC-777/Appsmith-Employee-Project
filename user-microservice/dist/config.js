...
exports.db_host_name = process.env.DB_HOST || 'mongodb+srv';
exports.db_user = process.env.DB_HOST || 'root';
exports.db_password = process.env.DB_HOST || 'root';
exports.db_cluster = process.env.DB_HOST || 'cluster0.rj2jb5r.mongodb.net';
