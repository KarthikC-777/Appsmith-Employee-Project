...
export class UserService {
  ...
  public async forgotPassword(body: forgotDto): Promise<boolean> {
    try {
      let formatError = {};
  ...
  public async resetPassword(resetDto: resetDto, req, res): Promise<void> {
    try {
      let formatError = {};
      ...
      const salt = await bcrypt.genSalt();
      const newPassword = await bcrypt.hash(resetDto.password, salt);
